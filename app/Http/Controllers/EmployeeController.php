...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($validator1->fails()){
            ...
            $employee->bsalary = $daily_rates ?? "0";
...
// }
    ...
    public function update($id)
    {
        ...
        // $employee = new Employee;
        // $employee=Employee::find($id);
        return view('admin.edit', ['employee'=>$employee, 'stations'=>Station::all(), 'positions'=>Position::all()]);
    ...
    public function edit(Request $request, $id)
    {
        ...
        $station=Station::select('station')->where('id', $station_id)->first();
        ...
        $employee->station_id = $request->station;
        $employee->station_name = $stationname;        
        $employee->email = $request->email ?? "No Email account";
