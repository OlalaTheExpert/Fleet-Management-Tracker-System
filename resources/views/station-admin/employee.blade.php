            ...
            <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">           
                ...
                <div class="profile-widget">
                    <div class="profile-img">
                        <a href="profile.html" class="avatar"><img src="{{ URL::asset('assets1/img/profiles/avatar.png') }}" alt=""></a>
                    </div>
                    <div class="dropdown profile-action">
                        <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                        <div class="dropdown-menu dropdown-menu-right">
                            
                            <a class="dropdown-item" href="{{route('employeestationedit', $employee->id)}}"  ><i class="fa fa-pencil m-r-5"></i> Edit</a>
                            {{-- <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#edit_employee_{{ $employee->id }}"><i class="fa fa-pencil m-r-5"></i> Edit</a> --}}
                            {{-- <a class="dropdown-item" href="{{route('destroystationempl', $employee->id)}}" onclick="confirmation(event)"><i class="fa fa-trash-o m-r-5"></i> Delete</a> --}}
                            <a class="dropdown-item" href="{{route('destroystationempl', $employee->id)}}" onclick="confirmation(event)" data-toggle="modal"><i class='fa fa-trash'></i> Delete</a> 
                        </div>
                        
                    </div>
                    <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{ route('profile') }}">{{ $employee->name }}</a></h4>
