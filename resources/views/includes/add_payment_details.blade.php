<!-- Add -->
<div class="modal  fade"  id="addnew121" >
                    ...
                    <form method="POST" action="{{ route('employees.store') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-lg-6">
                                ...
                                <input type="number" class="form-control" placeholder="Enter CTG Number" id="ctgnumber" name="ctgnumber"
                                    required />
                            </div>
                            ...
                            <div class="form-group col-md-6 col-lg-6">
                                ...
                                <input type="number" class="form-control" id="bsalary" name="bsalary" placeholder="Enter Basic Salary (USD)" required>
