                        ...
                        <div class="profile-view">
                            <div class="profile-img-wrap">
                                <div class="profile-img">
                                    <a href="#"><img alt="" src="{{ URL::asset('assets1/img/profiles/avatar-02.jpg')}}"></a>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            <div class="staff-id">Employee CTG NO : {{ $user->ctgnumber }}</div>
                                    ...
                                    <div class="col-md-7">
                                        <ul class="personal-info">
                                            <li>
                                                ...
                                                <div class="text"><a href="">{{ $user->phone_number }}</a></div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="text">
                                                   <div class="avatar-box">
                                                      <div class="avatar avatar-xs">
                                                         <img src="{{ URL::asset('assets1/img/user.jpg')}}" alt="">
                                                      </div>
                                                   </div>
                                                   <a href="profile.html">
                                                        {{ $user->reports_to }}
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{route('uppassword', $user->id)}}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {{-- <div class="profile-img-wrap edit-img">
                                    <img class="inline-block" src="{{ URL::asset('assets1/img/profiles/avatar-02.jpg') }}" alt="user">
