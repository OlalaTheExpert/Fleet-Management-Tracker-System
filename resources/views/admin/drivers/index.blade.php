                                    ...
                                    <div class="card-body">
                                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if($employee->position==="Driver" && $employee->stat !== "assigned")
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{route('drivers.update', $employee->id)}}" class="btn btn-success btn-sm edit btn-flat"><i class='fa fa-edit'></i> Assign</a>
