                        ...
                        <div class="profile-view">
                            <div class="profile-img-wrap">
                                <div class="profile-img">
                                    <a href="#"><img alt="" src="{{ URL::asset('assets1/img/user.jpg')}}"></a>
                                </div>
                            </div>
                                                ...
                                                <div class="text">
                                                   <div class="avatar-box">
                                                      <div class="avatar avatar-xs">
                                                         <img src="{{ URL::asset('assets11/img/profiles/avatar-16.jpg')}}" alt="">
                                                      </div>
                                                   </div>
                                                   <a href="profile.html">
                                                        {{ $user->reports_to }}
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{route('uppassword', $user->employee_id)}}">
                        @csrf
                        @method('PUT')
