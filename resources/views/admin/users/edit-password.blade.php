...
<!-- Edit -->
            ...
            <div class="modal-body text-left">
                <form class="form-horizontal" method="POST" action="{{ route('password.edit', $user->id) }}">
                    ...
                    {{-- <div id="div_id_name" class="form-group required"> 
                        <label for="id_name" class="control-label col-md-4  requiredField"> Plate Number<span class="asteriskField">*</span> </label> 
                        <div class="controls col-md-8 "> 
                            <input type="text" class="input-md textinput textInput form-control" id="plateno" name="plateno" value="{{ $vehicle->plateno }}"
                            required>
                        </div>
                    </div> --}}
